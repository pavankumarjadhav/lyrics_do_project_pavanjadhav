...
{
    append_lyrics='';
    append_lyrics +=  '<h1 class="song">'+data+'</h1>';
...
else
{
    ...
    {
        append_list +=  '<li class="song">'+song_data[i].title+'<a href="#"></a></li>';
    }
...
for(var i=visible_song_list_start_item;i<visible_song_list_end_item;i++)
{
    ...
    append_list +=  '<li class="song" onClick="getLyrics(song_title,song_artist)">'+song_title+'<a href="#"></a></li>';
}
...
{
    console.log(song_list_total_items,"---",visible_song_list_start_item,"---",visible_song_list_end_item)
